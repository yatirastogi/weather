...
class Search extends Component  {
       ...
       constructor(props) {
        ...
        back="https://nexusmedianews.com/wp-content/uploads/2019/12/sunrise-3533173_1920.jpg";
...
<h1 className="heading">Weather App</h1>
         ...
         <input type="text" name="searchcity" className="butt" onChange= {e => this.changestate(e.target.value)} placeholder="Type your city name..."></input>
